...
export const ParcelsLoaded = createAction(ParcelsActions.ParcelsLoaded, props<{ parcels: IParcelsResponse }>());

export const ParcelsError = createAction(ParcelsActions.ParcelsError, props<{ error: string }>());
