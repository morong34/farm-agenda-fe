...
const setParcels = (state: IParcelsState, { parcels }: { parcels: IParcelsResponse }) => ({ ...state, parcels });

const removeParcels = (state: IParcelsState) => ({ ...state, parcels: null });

const _parcelsReducer = createReducer<IParcelsState>(initialParcelsState, on(ParcelsLoaded, setParcels));
