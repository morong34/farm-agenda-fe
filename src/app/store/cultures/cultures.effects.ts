...
import { CulturesError, CulturesLoaded, CulturesRequested } from './cultures.actions';
import { catchError, map, mergeMap, of } from 'rxjs';

@Injectable()
export class CulturesEffects {
  constructor(private actions$: Actions, private culturesService: CultureService, private store: Store<IAppState>) {}
