...
const setPolygons = (state: IPolygonsState, { polygons }: { polygons: IPolygonsResponse }) => ({ ...state, polygons });
const removePolygons = (state: IPolygonsState) => ({ ...state, polygons: null });

const _polygonsReducer = createReducer<IPolygonsState>(initialPolygonsState, on(PolygonsLoaded, setPolygons));
