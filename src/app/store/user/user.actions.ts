...
export const UserLoaded = createAction(UserActions.UserLoaded, props<{ user: IUser }>());

export const UserError = createAction(UserActions.UserError, props<{ err: string }>());
